...
class ZaloFlutter {
  ...
  static const String zalo_login_success = 'result_login_zalo';
  ...
  static Future<Map?> initialize() async {
    Map? argument;
    channel.setMethodCallHandler((c) async {
      if (c.method == zalo_login_success) {
        argument = await c.arguments as Map;
      }
    });
    return argument;
  }
